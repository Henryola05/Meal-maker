...
get appetizers() {
  ...
  mains: this.mains,  // this uses the mains getter method
  desserts: this.desserts,  // this uses the desserts getter method
};
  },
...
menu.addDishToCourse('mains', 'tofu', 9.40);

menu.addDishToCourse('desserts', 'ice cream', 6.00);
menu.addDishToCourse('desserts', 'cake', 9.00);
menu.addDishToCourse('desserts', 'chocolate', 5.00);
